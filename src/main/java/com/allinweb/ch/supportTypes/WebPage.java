...
//
//        this.driver = arWebDriver.openDriver(url, optionsConfig, null, null, null);
//
...
//            InstructionLoadDTO instruction, String targetXPath, String action, String[] operations, String
// parentField)
//            throws Exception {
//
//        WebElement instructionElement = null;
...
//        if (data != null) {
//            String[] arr = UtilsMethods.splitIfContains(singleInstruction,
...
//            ((JavascriptExecutor) arWebDriver.getDriver()).executeScript("arguments[0].scrollIntoView(true);",
// element);
